...
fs.copy_file(path.OpenSource / 'Lua' / 'build' / 'bin' / 'Win32' / configuration / 'lua53.dll', path.Result / 'bin' / 'lua53.dll', true)
fs.copy_file(path.OpenSource / 'Lua' / 'build' / 'bin' / 'Win32' / configuration / 'lua.exe', path.Result / 'bin' / 'lua.exe', true)
...
fs.copy_file(path.OpenSource / 'luaffi' / 'bin' / 'Win32' / configuration / 'ffi.dll', path.Result / 'bin' / 'modules' / 'ffi.dll', true)
