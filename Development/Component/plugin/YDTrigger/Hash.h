...
#define YDLocal1Release()                          YDHashClearTable(YDHASH_HANDLE, YDLOCAL_1)
# // 2.
...
#define YDLocal3Release()                          YDHashClearTable(YDHASH_HANDLE, YDLOCAL_3)
# // 4.
...
#define YDLocal4Release()                          YDHashClearTable(YDHASH_HANDLE, YDLOCAL_4)
# // 5.
...
#
#define YDLocalSet(page, type, name, value)             YDHashSet(YDHASH_HANDLE, type, YDHashH2I(page), <?=StringHash(name)?>, value)
#define YDLocalArraySet(page, type, name, index, value) YDHashSet(YDHASH_HANDLE, type, YDHashH2I(page), <?=StringHash(name)?> + (index), value)
#define YDLocalGet(page, type, name)                    YDHashGet(YDHASH_HANDLE, type, YDHashH2I(page), <?=StringHash(name)?>)
#define YDLocalArrayGet(page, type, name, index)        YDHashGet(YDHASH_HANDLE, type, YDHashH2I(page), <?=StringHash(name)?> + (index))
#define YDLocalRelease(page)                            YDHashClearTable(YDHASH_HANDLE, YDHashH2I(page))
#
#endif
