...
enum GUIID_User_Defined
{
  ...
  CC_GUIID_GroupEnumUnitsInRangeOfLocCounted,
  CC_GUIID_GetUnitsInRectMatching,
  CC_GUIID_GetUnitsInRangeOfLocMatching,
  CC_GUIID_GetUnitsOfPlayerMatching,
  CC_GUIID_GetPlayersMatching,
