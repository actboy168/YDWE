...
{
	virtual_mpq::initialize();

	using namespace luabind;
	module(pState, "virtual_mpq")
	[
		def("open_path", &virtual_mpq::open_path)
	];

	//virtual_mpq::open_path(L"share\\mpq\\ydtrigger", 15);
	//virtual_mpq::open_path(L"share\\mpq\\ydwe",      14);
	//virtual_mpq::open_path(L"share\\mpq\\units",     13);
