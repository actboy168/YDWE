...
#define DEFINE_FP_CALL_ASSERT(z, n, param) static_assert(sizeof(uintptr_t) == sizeof(BOOST_PP_CAT(param, n)), "sizeof(uintptr_t) != sizeof(" ## BOOST_PP_STRINGIZE(BOOST_PP_CAT(param, n)) ## ")");
