...
int _fastcall CC_Put_YDWELoadAnyTypeDataByUserData(DWORD This, DWORD OutClass, char* name, char* type_name);
int _fastcall CC_Put_YDWEHaveSavedAnyTypeDataByUserData(DWORD This, DWORD OutClass, char* name);
