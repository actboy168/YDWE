...
namespace base { namespace warcraft3 { namespace jass {
	...
	_BASE_API bool     japi_once_hook    (const char* proc_name, uintptr_t* old_proc_ptr, uintptr_t new_proc);
	_BASE_API bool     japi_add          (uintptr_t func, const char* name, const char* param);
	_BASE_API bool     japi_table_add    (uintptr_t func, const char* name, const char* param);
