...
globals
    integer array YDWEADDBONUS_DATA  // bouns    
    private integer BONUS_ARMOR = 0 // Armor Bonus
    private integer BONUS_DAMAGE = 1 // Damage Bonus
    private integer BONUS_MAXLIFE_REGEN = 2 // Life MaxState Bonus 
    private integer BONUS_MAXMANA_REGEN = 3 // Mana MaxState Bonus          
    private integer NUM=16 
    ...
    public integer array MaxBonus
    public integer array MinBonus
endglobals
...
private function DisplayAllAbilityId takes nothing returns nothing
    ...
    private function SetUnitMaxState takes unit u,integer bonusType,real value returns boolean
        ...
        if value>(Pow(2,NUM)-1) or value<=0 then
...
//    loop 
//        exitwhen m>(ABILITY_NUM[2]-1)
//        set BonusAbilitys[i] = '!dm0' -'0'+myChar[m]// +1
//        set i=i+1
//        set m=m+1
//    endloop
...
//    loop 
//        exitwhen m>(ABILITY_NUM[3]-1)
//        set BonusAbilitys[i] = '!dl0' -'0'+myChar[m]// +1
//        set i=i+1
//        set m=m+1
//    endloop
...
//        set BonusAbilitys[i] = '!dT0' -'0'+myChar[m]// +1
//        set i=i+1
//        set m=m+1
//    endloop
...
function YDWELifeChange takes unit u,integer mod,integer ch,integer id returns nothing
    ...
    //if yd_IsAddBonusAbility == true then
    //    set aid = 'YdA0'
    //endif     
