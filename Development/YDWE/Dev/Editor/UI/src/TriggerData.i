...
TC_YDAB=¼¼ÄÜ[YDWE],ReplaceableTextures\CommandButtons\BTNImmolationOn.blp
TC_YDST=ÏµÍ³[YDWE],ReplaceableTextures\CommandButtons\BTNMetamorphosis.blp
TC_YDFC=º¯Êý[YDWE],ReplaceableTextures\CommandButtons\BTNEvasion.blp
TC_YDLD=´æ´¢[YDWE],ReplaceableTextures\CommandButtons\BTNLoad.blp
TC_YDSE=ÌØÐ§[YDWE],ReplaceableTextures\PassiveButtons\PASBTNFeedBack.blp



TC_YDLC=±äÁ¿[YDWE],ReplaceableTextures\WorldEditUI\Editor-ScriptVariable.blp

TC_YDAI=AI[YDWE],ReplaceableTextures\CommandButtons\BTNHeroTinker.blp
TC_YDET=ÊÂ¼þ[YDWE],UI\Widgets\ToolTips\Human\ToolTipStonesIcon.blp
TC_YDBF=ÄæÌì[YDWE],ReplaceableTextures\CommandButtons\BTNInfernal.blp
TC_YDSL=´æµµ[YDWE],ReplaceableTextures\CommandButtons\BTNTome.blp
TC_SCRIPTSET=µçÓ°<Script System>,ReplaceableTextures\WorldEditUI\Doodad-Cinematic.blp
...
TC_UNITPOOL=µ¥Î»³Ø,ReplaceableTextures\WorldEditUI\Actions-Unit
...
TC_LOCATION=µã,ReplaceableTextures\CommandButtons\BTNStun.blp
...
TC_TRACKABLE=¿É×·×ÙÎï,ReplaceableTextures\WorldEditUI\Actions-Game
...
TC_REGION=ÇøÓò(²»¹æÔò),ReplaceableTextures\WorldEditUI\Actions-Region
TC_RECT=ÇøÓò(¾ØÐÎ),ReplaceableTextures\WorldEditUI\Actions-Region
TC_YDID=»ñÈ¡ÕûÊý,ReplaceableTextures\CommandButtons\BTNSelectHeroOn.blp
...
TC_ITEMPOOL=ÎïÆ·³Ø,ReplaceableTextures\WorldEditUI\Actions-Item
...
TC_YDHIDE=²»ÍÆ¼öÊ¹ÓÃ,ReplaceableTextures\CommandButtons\BTNCancel.blp
...
multiboarditem=1,1,0,¶àÃæ°åÏîÄ¿
camerasetup=0,1,0,WESTRING_TRIGTYPE_camerasetup
trackable=0,1,0,¿É×·×ÙÎï
...
boolexpr=0,1,0,²¼¶û±í´ïÊ½
radian=0,1,1,»¡¶È,real
degree=0,1,1,½Ç¶È,real
...
unitstatechangetype=0,0,0,µ¥Î»×´Ì¬ÐÞ¸ÄÀàÐÍ,integer
bonusType=0,0,0,ÊôÐÔÀàÐÍ,integer
eventid=0,0,0,ÊÂ¼þID
...
//removeguardtype=0,0,0,æ•´æ•°,integer 
//targetattach=0,1,1,èº«ä½“éƒ¨ä½,string
turnclockwise=0,0,1,µ¥Î»×ªÏòÀàÐÍ,integer 
headORchest=0,0,1,Í·²¿»òÐØ²¿,integer 
camerachangetype=0,0,1,¾µÍ·ÇÐ»»·½Ê½,integer 
camerastattype=0,0,1,¾µÍ·²ÎÊýÀàÐÍ,integer 
cameratgnoreterrain=0,0,1,¾µÍ·ºöÂÔÐüÑÂ,boolean 
attackorattackedevent=0,0,1,ÊÂ¼þÀàÐÍ,integer 
targettype=0,0,1,Ä¿±êÀàÐÍ,integer 
...
nearestonlyoption=0,0,0,Ñ¡È¡·½Ê½,boolean
vertonlyoption=0,0,0,»Î¶¯·½Ê½,boolean
...
isnotoption=0,0,0,ÅÐ¶ÏÑ¡Ïî,boolean
pingstyle=1,0,0,WESTRING_TRIGTYPE_minimappingstyle,boolean
hotkeyint=0,0,0,¿ì½Ý¼ü,integer
sharevisionoption=0,0,0,¹²ÏíÊÓÒ°Ñ¡Ïî,boolean
converunitoption=0,0,0,¸²¸ÇÑ¡Ïî,boolean
lockunlockoption=0,0,0,Ëø¶¨Ñ¡Ïî,boolean
...
abilevent=0,0,0,¼¼ÄÜÀàÐÍ,integer
racepreference=0,0,0,ÖÖ×åÑ¡Ïî

AbilityState=0,0,0,¼¼ÄÜÊôÐÔ,integer
AbilityDataInteger=0,0,0,¼¼ÄÜÊý¾Ý (ÕûÊý),integer
AbilityDataReal=0,0,0,¼¼ÄÜÊý¾Ý (ÊµÊý),integer
AbilityDataString=0,0,0,¼¼ÄÜÊý¾Ý (×Ö·û´®),integer
ChatRecipient=0,0,0,ÆµµÀÀàÐÍ,integer
...
region=CreateRegion(),ÐÂ½¨²»¹æÔòÇøÓò
...
//YDWE ä¿®æ”¹å±žæ€§
bonusTypeC=0,bonusType,3,¹¥»÷
bonusTypeD=0,bonusType,2,·ÀÓù 
bonusTypeA=0,bonusType,0,ÉúÃüÉÏÏÞ
bonusTypeB=0,bonusType,1,Ä§·¨ÉÏÏÞ

//YDWE ä¿®æ”¹å•ä½ 
//targetattachA=0,targetattach,"overhead",å¤´é¡¶  
unitstatechangetypeA=0,unitstatechangetype,0,Ôö¼Ó
unitstatechangetypeB=0,unitstatechangetype,1,¼õÉÙ
unitstatechangetypeC=0,unitstatechangetype,2,µÈÓÚ
//removeguardtypeA=0,removeguardtype,1,ä½£å…µæ­»äº¡ 
//removeguardtypeB=0,removeguardtype,2,ä¸»äººæ­»äº¡ 
//removeguardtypeC=0,removeguardtype,3,ä½£å…µæˆ–ä¸»äººæ­»äº¡ 

turnclockwiseA=0,turnclockwise,1,ÄæÊ±Õë 
turnclockwiseB=0,turnclockwise,-1,Ë³Ê±Õë 
turnclockwiseC=0,turnclockwise,0,×î½ü·½Ïò 

headORchestA=0,headORchest,0,Í·²¿ 
headORchestB=0,headORchest,1,ÐØ²¿ 

camerachangetypeA=0,camerachangetype,1,Á¢¼´
camerachangetypeB=0,camerachangetype,2,ÏßÐÔ
camerachangetypeC=0,camerachangetype,3,Æ½»¬
camerachangetypeD=0,camerachangetype,4,Æ½»¬ºóÍ£Ö¹

camerastattypeA=0,camerastattype,1,X×ø±ê(Ä¿±êXÖá) 
camerastattypeB=0,camerastattype,2,Y×ø±ê(Ä¿±êYÖá)  
camerastattypeC=0,camerastattype,3,Z×ø±ê(ZÖáÆ«ÒÆ) 
camerastattypeD=0,camerastattype,4,ÃæÏò½Ç¶È(ZÖáÐý×ª½Ç¶È) 
camerastattypeE=0,camerastattype,5,Ñö½Ç(XÖáÐý×ª½Ç¶È) 
camerastattypeF=0,camerastattype,6,ÇãÐ±½Ç¶È(YÖáÐý×ª½Ç¶È)  
camerastattypeG=0,camerastattype,7,ÊÓÒ°·¶Î§(¾µÍ·ÇøÓò) 
camerastattypeH=0,camerastattype,8,Ô¶´¦²Ã¾°(Ô¶´¦½Ø¶Ï¾àÀë) 
camerastattypeI=0,camerastattype,9,¾µÍ·Ä¿±ê¾àÀë(¾µÍ·¾àÀë) 

cameratgnoreterrainA=0,cameratgnoreterrain,false,²»ºöÂÔ
cameratgnoreterrainB=0,cameratgnoreterrain,true,ºöÂÔ 

//æ”»å‡»æˆ–è¢«æ”»å‡»äº‹ä»¶
attackorattackedeventA=0,attackorattackedevent,0,±»¹¥»÷ 
attackorattackedeventB=0,attackorattackedevent,1,¹¥»÷ 
//æŠ€èƒ½æ–½æ”¾ç›®æ ‡ 
targettypeA=0,targettype,1,¶ÔµÐÈË 
targettypeB=0,targettype,2,¶Ôµã 
targettypeC=0,targettype,3,Á¢¼´
targettypeD=0,targettype,4,¶Ô×Ô¼º
...
//Integer
bj_forLoopAIndex=0,integer,bj_forLoopAIndex,Ñ­»·ÕûÊýA [R]
bj_forLoopBIndex=0,integer,bj_forLoopBIndex,Ñ­»·ÕûÊýB [R]

abileventA=0,abilevent,1,»·ÈÆ(ÌØÐ§) 
abileventB=0,abilevent,2,ÌøÔ¾
abileventC=0,abilevent,3,Ë¿´ø
abileventD=0,abilevent,4,¹³×Ó(ÃüÖÐ)
abileventE=0,abilevent,5,¹³×Ó(·µ»Ø)
abileventF=0,abilevent,6,³å·æ
abileventG=0,abilevent,7,ÌøÅü
abileventH=0,abilevent,8,ÔÂÉñ¼ý(ÃüÖÐ)
abileventI=0,abilevent,9,ÔÂÉñ¼ý(ÏûÊ§)
abileventJ=0,abilevent,10,»·ÈÆ(Ä£°å) 
...
bj_lastTransmissionDuration=0,real,bj_lastTransmissionDuration,×îºó·¢ÑÔ³¤¶È [R]
RealE=0,real,bj_E,WESTRING_REAL_E
RealPi=0,real,bj_PI,WESTRING_REAL_PI

//ScriptCode
ScriptCode00=0,scriptcode,exitwhen true,ÍË³öµ±Ç°Ñ­»· [R]
ScriptCode01=0,scriptcode,call DisableTrigger(bj_cineSceneBeingSkipped),½ûÓÃESCÌø¹ýµçÓ°ÏûÏ¢ [R]
ScriptCode02=0,scriptcode,call EnableTrigger(bj_cineSceneBeingSkipped),ÆôÓÃESCÌø¹ýµçÓ°ÏûÏ¢ [R]

// Players
Player00=0,player,Player(0),WESTRING_PLAYER_00
PlayerALL=0,player,Player(n),ÈÎÒâÍæ¼Ò
...
bj_FORCE_ALL_PLAYERS=0,force,bj_FORCE_ALL_PLAYERS,È«²¿Íæ¼Ò [R]
...
RaceUnknown=0,race,ConvertRace(0),Ã»ÓÐ
RaceOther=0,race,ConvertRace(7),ÆäËû
RaceCreeps=0,race,ConvertRace(8),Ò°ÍâÉúÎï
RaceCommoner=0,race,ConvertRace(9),Æ½Ãñ
RaceCritters=0,race,ConvertRace(10),¶¯Îï
RaceNaga=0,race,ConvertRace(11),ÄÈåÈ
...
//HotKeyInt
HotKeyIntNull=0,hotkeyint,0,ÎÞ
...
// Boolean
bj_lastLoadPreloadSLResult=0,boolean,bj_lastLoadPreloadSLResult,×îºó¶ÁÈ¡µÄ´æµµÎªÓÐÐ§ [YDWE]
// Units
UnitNull=0,unit,null,WESTRING_TRIGUNIT_NULL
bj_lastCreatedUnit=0,unit,bj_lastCreatedUnit,×îºó´´½¨µÄµ¥Î» [R]
bj_lastLoadedUnit=0,unit,bj_lastLoadedUnit,×îºó¶ÁÈ¡µÄµ¥Î» [R]
bj_lastReplacedUnit=0,unit,bj_lastReplacedUnit,×îºóÌæ»»µÄµ¥Î» [R]
bj_lastHauntedGoldMine=0,unit,bj_lastHauntedGoldMine,×îºó´´½¨µÄ²»ËÀ×å½ð¿ó [R]
bj_lastPoolAbstractedUnit=0,unit,bj_lastPoolAbstractedUnit,×îºó´Óµ¥Î»³ØÖÐÈ¡³öµÄµ¥Î» [YDWE]
bj_lastAbilityCastingUnit=0,unit,bj_lastAbilityCastingUnit,×îºóÊ©·ÅÌØÊâ¼¼ÄÜµÄµ¥Î» [YDWE]
bj_lastAbilityTargetUnit=0,unit,bj_lastAbilityTargetUnit,×îºó±»ÌØÊâ¼¼ÄÜÃüÖÐµÄµ¥Î» [YDWE]

// Unit pool
bj_lastCreatedUnitPool=0,unitpool,bj_lastCreatedUnitPool,×îºó´´½¨µÄµ¥Î»³Ø [YDWE]

// Unit-Types
UnitTypeNull=0,unitcode,0,WESTRING_TRIGUNITTYPE_NULL

//Group
bj_lastCreatedGroup=0,group,bj_lastCreatedGroup,×îºó´´½¨µÄµ¥Î»×é [R]

// Items
ItemNull=0,item,null,WESTRING_TRIGITEM_NULL
bj_lastCreatedItem=0,item,bj_lastCreatedItem,×îºó´´½¨µÄÎïÆ· [R]
bj_lastRemovedItem=0,item,bj_lastRemovedItem,×îºó¶ªÆúµÄÎïÆ· [R]
bj_lastMovedItemInItemSlot=0,item,bj_lastMovedItemInItemSlot,×îºóÔÚÎïÆ·À¸ÖÐÒÆ¶¯µÄÎïÆ· [YDWE]

// item pool
bj_lastCreatedItemPool=0,itempool,bj_lastCreatedItemPool,×îºó´´½¨µÄÎïÆ·³Ø [YDWE]

// Destructables
DestructableNull=0,destructable,null,WESTRING_TRIGDESTRUCTABLE_NULL
bj_lastCreatedDestructable=0,destructable,bj_lastCreatedDestructable,×îºó´´½¨µÄ¿ÉÆÆ»µÎï [R]

// Quest
bj_lastCreatedQuest=0,quest,bj_lastCreatedQuest,×îºó´´½¨µÄÈÎÎñ [R]

// Questitem
bj_lastCreatedQuestItem=0,questitem,bj_lastCreatedQuestItem,×îºó´´½¨µÄÈÎÎñÏîÄ¿ [R]

// DefeatCondition
bj_lastCreatedDefeatCondition=0,defeatcondition,bj_lastCreatedDefeatCondition,×îºó´´½¨µÄÊ§°ÜÌõ¼þ [R]

//Leaderboard
bj_lastCreatedLeaderboard=0,leaderboard,bj_lastCreatedLeaderboard,×îºó´´½¨µÄÅÅÐÐ°ñ [R]

//multiboard
bj_lastCreatedMultiboard=0,multiboard,bj_lastCreatedMultiboard,×îºó´´½¨µÄ¶àÃæ°å [R]

//Timer
bj_lastStartedTimer=0,timer,bj_lastStartedTimer,×îºóÆôÓÃµÄ¼ÆÊ±Æ÷ [R]

// TimerDialog
bj_lastCreatedTimerDialog=0,timerdialog,bj_lastCreatedTimerDialog,×îºó´´½¨µÄ¼ÆÊ±Æ÷´°¿Ú [R]

// Button
bj_lastCreatedButton=0,button,bj_lastCreatedButton,×îºó´´½¨µÄ¶Ô»°¿ò°´Å¥ [R]

// Rects
RectNull=0,rect,null,WESTRING_TRIGRECT_NULL
bj_mapInitialPlayableArea=0,rect,bj_mapInitialPlayableArea,¿ÉÓÃµØÍ¼ÇøÓò [R]
bj_mapInitialCameraBounds=0,rect,bj_mapInitialCameraBounds,³õÊ¼¿ÉÓÃ¾µÍ·ÇøÓò [R]

// Effect
bj_lastCreatedEffect=0,effect,bj_lastCreatedEffect,×îºó´´½¨µÄÌØÐ§ [R]

// Lightning
bj_lastCreatedLightning=0,lightning,bj_lastCreatedLightning,×îºó´´½¨µÄÉÁµçÐ§¹û [R]

// Image
bj_lastCreatedImage=0,image,bj_lastCreatedImage,×îºó´´½¨µÄÍ¼Ïñ [R]

// Ubersplat
bj_lastCreatedUbersplat=0,ubersplat,bj_lastCreatedUbersplat,×îºó´´½¨µÄµØÃæÎÆÀí±ä»¯ [R]

// WeatherEffect
bj_lastCreatedWeatherEffect=0,weathereffect,bj_lastCreatedWeatherEffect,×îºó´´½¨µÄÌìÆøÐ§¹û [R]

// TerrainDeformation
bj_lastCreatedTerrainDeformation=0,terraindeformation,bj_lastCreatedTerrainDeformation,×îºó´´½¨µÄµØÐÎ±ä»¯ [R]

// FogModifier
bj_lastCreatedFogModifier=0,fogmodifier,bj_lastCreatedFogModifier,×îºó´´½¨µÄ¿É¼û¶ÈÐÞÕýÆ÷ [R]

// GameCache
bj_lastCreatedGameCache=0,gamecache,bj_lastCreatedGameCache,×îºó´´½¨µÄÓÎÏ·»º´æ [R]

//TextTag
bj_lastCreatedTextTag=0,texttag,bj_lastCreatedTextTag,×îºó´´½¨µÄÆ¯¸¡ÎÄ×Ö [R]

// Sounds
SoundNull=0,sound,null,WESTRING_TRIGSOUND_NULL
bj_lastPlayedSound=0,sound,bj_lastPlayedSound,×îºó²¥·ÅµÄÒôÐ§ [R]

// Music
MusicFileMusic=0,musicfile,`music`,WESTRING_TRIGMUSICFILE_MUSIC
bj_lastPlayedMusic=0,musicfile,bj_lastPlayedMusic,×îºó²¥·ÅµÄÒôÀÖ [R]

//AttackType
bj_lastSetAttackType=0,attacktype,bj_lastSetAttackType,×îºóÉèÖÃµÄ¹¥»÷ÀàÐÍ [YDWE]

//DamageType
bj_lastSetDamageType=0,damagetype,bj_lastSetDamageType,×îºóÉèÖÃµÄÉËº¦ÀàÐÍ [YDWE]

//WeaponType
bj_lastSetWeaponType=0,weapontype,bj_lastSetWeaponType,×îºóÉèÖÃµÄÎäÆ÷ÀàÐÍ [YDWE]
...
//MapFlagLockSpeed=0,mapflag,MAP_LOCK_SPEED,é”å®šæ¸¸æˆé€Ÿåº¦ [R]
...
bj_lastCreatedHashtable=0,hashtable,bj_lastCreatedHashtable,×îºó´´½¨µÄ¹þÏ£±í [C]
...
UnitEventSummon=0,unitevent,EVENT_UNIT_SUMMON,"ÕÙ»½Ò»¸öµ¥Î» [R]"
...
UnitStateDamageDice=0,unitstate,ConvertUnitState(0x10),"÷»×ÓÊýÁ¿ [JAPI]"
UnitStateDamageSide=0,unitstate,ConvertUnitState(0x11),"÷»×ÓÃæÊý [JAPI]"
UnitStateDamageBase=0,unitstate,ConvertUnitState(0x12),"»ù´¡ÉËº¦ [JAPI]"
UnitStateDamageBonus=0,unitstate,ConvertUnitState(0x13),"¸½¼ÓÉËº¦ [JAPI]"
UnitStateDamageMix=0,unitstate,ConvertUnitState(0x14),"¹¥»÷×îÐ¡Öµ [JAPI]"
UnitStateDamageMax=0,unitstate,ConvertUnitState(0x15),"¹¥»÷×î´óÖµ [JAPI]"
UnitStateDamageRange=0,unitstate,ConvertUnitState(0x16),"¹¥»÷·¶Î§ [JAPI]"
UnitStateArmor=0,unitstate,ConvertUnitState(0x20),"»¤¼× [JAPI]"
...
UnitStateDamageDiceSec=0,unitstatesec,ConvertUnitState(0x10),"÷»×ÓÊýÁ¿ [JAPI]"
UnitStateDamageSideSec=0,unitstatesec,ConvertUnitState(0x11),"÷»×ÓÃæÊý [JAPI]"
UnitStateDamageBaseSec=0,unitstatesec,ConvertUnitState(0x12),"»ù´¡ÉËº¦ [JAPI]"
UnitStateDamageBonusSec=0,unitstatesec,ConvertUnitState(0x13),"¸½¼ÓÉËº¦ [JAPI]"
UnitStateDamageRangeSec=0,unitstatesec,ConvertUnitState(0x16),"¹¥»÷·¶Î§ [JAPI]"
UnitStateArmorSec=0,unitstatesec,ConvertUnitState(0x20),"»¤¼× [JAPI]"
...
UnitTypeDead=0,unittype,UNIT_TYPE_DEAD,ËÀÍöµÄ [R]
...
UnitTypeGiant=0,unittype,UNIT_TYPE_GIANT,Ì©Ì¹×å [R]
UnitTypeTauren=0,unittype,UNIT_TYPE_TAUREN,Å£Í·ÈË [R]
...
UnitTypeGiantAdd=0,unittypeaddable,UNIT_TYPE_GIANT,Ì©Ì¹×å
UnitTypeTaurenAdd=0,unittypeaddable,UNIT_TYPE_TAUREN,Å£Í·ÈË
...
// Weapon types
WEAPON_TYPE_WHOKNOWS=1,weapontype,WEAPON_TYPE_WHOKNOWS,ÎÞ
...
//NearestOnlyOption
NearestOnlyOn=0,nearestonlyoption,true,Ö»Ñ¡È¡×î½üµÄÒ»¸öµ¥Î»
NearestOnlyOff=0,nearestonlyoption,false,Ñ¡È¡·¶Î§ÄÚËùÓÐµ¥Î»

//IsNotOption
IsNotIs=0,isnotoption,true,ÊÇ
IsNotNot=0,isnotoption,false,²»ÊÇ

//LockUnLockOption
LockUnLockLock=0,lockunlockoption,true,Ëø¶¨
LockUnLockUnLock=0,lockunlockoption,false,½â³ýËø¶¨

//VertOnlyOption
VertOnlyOn=0,vertonlyoption,true,´¹Ö±»Î¶¯
VertOnlyOff=0,vertonlyoption,false,Ë®Æ½»Î¶¯

//pingstyle
PingStyleNormal=0,pingstyle,true,¾ªÌ¾ºÅ
PingStyleExtra=0,pingstyle,false,ÆÕÍ¨

//sharevisionoption=0,0,0,å…±äº«è§†é‡Žé€‰é¡¹,boolean
ShareVisionShare=0,sharevisionoption,true,¹²Ïí
ShareVisionNot=0,sharevisionoption,false,²»¹²Ïí

//converunitoption
ConverUnitConver=0,converunitoption,true,¸²¸Ç
ConverUnitNot=0,converunitoption,false,²»¸²¸Ç
...
// Common
UnitOrderAttackUnitnull=0,unitorderutarg,null,ÎÞ 
...
UnitOrderAncestralSpiritTarg=1,unitorderutarg,`ancestralspirittarg`,ÊÞ×åÁé»êÐÐÕß - ÏÈ×æÓÄÁé(ÎÞÐ§)
...
// Neutral
UnitTargetOrderBreathOfFrost=1,unitorderutarg,`breathoffrost`,ÖÐÁ¢ - Ëª¶³ÍÂÏ¢ [R]
...
UnitOrderNeutralInterAct=0,unitorderutarg,`neutralinteract`,ÖÐÁ¢ÉÌµê - Ñ¡Ôñµ¥Î» [R]

// Trigger Point-Targeted Unit Orders
// Common
UnitOrderAttacknull=0,unitorderptarg,null,ÎÞ 
...
UnitOrderNeutralDetectAOE=0,unitorderptarg,`neutraldetectaoe`,µØ¾«ÊµÑéÊÒ - Õì²é [R]
...
UnitOrderMoveItem=1,unitorderitarg,`move`,ÒÆ¶¯(ÎÞÐ§)
...
// Common
UnitOrderStopnull=0,unitordernotarg,null,ÎÞ 
...
UnitOrderMagicDefense=1,unitordernotarg,`magicdefense`,ÈË×åÆÆ·¨Õß - ¼¤»îÄ§·¨·ÀÓù [R]
UnitOrderMagicUnDefense=1,unitordernotarg,`magicundefense`,ÈË×åÆÆ·¨Õß - È¡ÏûÄ§·¨·ÀÓù [R]
...
UnitOrderCarrionScarabsInstant=1,unitordernotarg,`carrionscarabsinstant`,"²»ËÀ×åµØÑ¨ÁìÖ÷ - ÕÙ»½¸¯Ê¬¼×³æ [R]"
...
UnitOrderSubmerge=1,unitordernotarg,`submerge`,ÄÈåÈ - Ç±Ë® [R]
UnitOrderUnSubmerge=1,unitordernotarg,`unsubmerge`,ÄÈåÈ - È¡ÏûÇ±Ë® [R]
UnitOrderParasiteOn=1,unitordernotarg,`parasiteon`,ÄÈåÈº£Ñý - ¼¤»î¼ÄÉú³æ [R]
UnitOrderParasiteOff=1,unitordernotarg,`parasiteoff`,ÄÈåÈº£Ñý - È¡Ïû¼ÄÉú³æ [R]
...
OrderCodeNeutralInterAct=0,ordercodeutarg,852566,ÖÐÁ¢ÉÌµê - Ñ¡Ôñµ¥Î»
OrderCodeItemIllusion=1,ordercodeutarg,852274,ÎïÆ·¼¼ÄÜ - »ÃÏóÈ¨ÕÈ
OrderCodeItemChainDispel=1,ordercodeutarg,852615,ÎïÆ·¼¼ÄÜ - Á¬ËøÇýÖð
...
OrderCodeReveal=1,ordercodeptarg,852270,ÈË×åÉñÃØÖ®Ëþ - ÏÔÊ¾
...
OrderCodeNeutralDetectAOE=0,ordercodeptarg,852023,µØ¾«ÊµÑéÊÒ - Õì²é
...
OrderCodeMoveItem0=1,ordercodeitarg,852002,ÒÆ¶¯ÎïÆ·µ½µÚ1¸ñ
OrderCodeMoveItem1=1,ordercodeitarg,852003,ÒÆ¶¯ÎïÆ·µ½µÚ2¸ñ
OrderCodeMoveItem2=1,ordercodeitarg,852004,ÒÆ¶¯ÎïÆ·µ½µÚ3¸ñ
OrderCodeMoveItem3=1,ordercodeitarg,852005,ÒÆ¶¯ÎïÆ·µ½µÚ4¸ñ
OrderCodeMoveItem4=1,ordercodeitarg,852006,ÒÆ¶¯ÎïÆ·µ½µÚ5¸ñ
OrderCodeMoveItem5=1,ordercodeitarg,852007,ÒÆ¶¯ÎïÆ·µ½µÚ6¸ñ
OrderCodeRandomItem=1,ordercodeitarg,852622,ÎïÆ·¼¼ÄÜ - Ëæ»úÎïÆ·
...
OrderCodeHeroSkill=1,ordercodenotarg,852000,´ò¿ª¼¼ÄÜ²Ëµ¥
OrderCodeCancel=0,ordercodenotarg,851976,È¡Ïû(ÑµÁ·¡¢Éý¼¶¡¢ÑÐ¾¿)
OrderCodeUseItem0=1,ordercodenotarg,852008,Ê¹ÓÃµÚ1¸ñÎïÆ·(ÎÞÐ§)
OrderCodeUseItem1=1,ordercodenotarg,852009,Ê¹ÓÃµÚ2¸ñÎïÆ·(ÎÞÐ§)
OrderCodeUseItem2=1,ordercodenotarg,852010,Ê¹ÓÃµÚ3¸ñÎïÆ·(ÎÞÐ§)
OrderCodeUseItem3=1,ordercodenotarg,852011,Ê¹ÓÃµÚ4¸ñÎïÆ·(ÎÞÐ§)
OrderCodeUseItem4=1,ordercodenotarg,852012,Ê¹ÓÃµÚ5¸ñÎïÆ·(ÎÞÐ§)
OrderCodeUseItem5=1,ordercodenotarg,852013,Ê¹ÓÃµÚ6¸ñÎïÆ·(ÎÞÐ§)
...
OrderCodeMagicDefense=1,ordercodenotarg,852478,ÈË×åÆÆ·¨Õß - ¼¤»îÄ§·¨·ÀÓù
OrderCodeMagicUnDefense=1,ordercodenotarg,852479,ÈË×åÆÆ·¨Õß - È¡ÏûÄ§·¨·ÀÓù
...
OrderCodeCarrionScarabsInstant=1,ordercodenotarg,852554,"²»ËÀ×åµØÑ¨ÁìÖ÷ - ÕÙ»½¸¯Ê¬¼×³æ"
...
OrderCodeSubmerge=1,ordercodenotarg,852604,ÄÈåÈ - Ç±Ë®
OrderCodeUnSubmerge=1,ordercodenotarg,852605,ÄÈåÈ - È¡ÏûÇ±Ë®
OrderCodeParasiteOn=1,ordercodenotarg,852602,ÄÈåÈº£Ñý - ¼¤»î¼ÄÉú³æ
OrderCodeParasiteOff=1,ordercodenotarg,852603,ÄÈåÈº£Ñý - È¡Ïû¼ÄÉú³æ
...
OrderCodeDustOfAppearance=1,ordercodenotarg,852621,ÎïÆ·¼¼ÄÜ - ÔÂÁÁÊ¯
OrderCodeDustOfAppearance=1,ordercodenotarg,852625,ÎïÆ·¼¼ÄÜ - ÏÔÓ°Ö®³¾
...
RacePrefRandom=0,racepreference,RACE_PREF_RANDOM,Ëæ»ú
...
//=================================================== 
ID_EVENT_GAME_VICTORY=0,eventid,EVENT_GAME_VICTORY,"(000)ÓÎÏ·ÊÂ¼þ - ÓÎÏ·Ê¤Àû"
ID_EVENT_GAME_END_LEVEL=0,eventid,EVENT_GAME_END_LEVEL,"(001)ÓÎÏ·ÊÂ¼þ - ÓÎÏ·½áÊø"
ID_EVENT_GAME_VARIABLE_LIMIT=0,eventid,EVENT_GAME_VARIABLE_LIMIT,"(002)ÓÎÏ·ÊÂ¼þ - ±äÁ¿¸Ä±ä"
ID_EVENT_GAME_STATE_LIMIT=0,eventid,EVENT_GAME_STATE_LIMIT,"(003)ÓÎÏ·ÊÂ¼þ - ×´Ì¬¸Ä±ä"
ID_EVENT_GAME_TIMER_EXPIRED=0,eventid,EVENT_GAME_TIMER_EXPIRED,"(004)ÓÎÏ·ÊÂ¼þ - ¼ÆÊ±Æ÷µ½ÆÚ"
ID_EVENT_GAME_ENTER_REGION=0,eventid,EVENT_GAME_ENTER_REGION,"(005)ÓÎÏ·ÊÂ¼þ - ½øÈëÇøÓò"
ID_EVENT_GAME_LEAVE_REGION=0,eventid,EVENT_GAME_LEAVE_REGION,"(006)ÓÎÏ·ÊÂ¼þ - Àë¿ªÇøÓò"
ID_EVENT_GAME_TRACKABLE_HIT=0,eventid,EVENT_GAME_TRACKABLE_HIT,"(007)ÓÎÏ·ÊÂ¼þ - Êó±êµã»÷¿É×·×ÙÎï"
ID_EVENT_GAME_TRACKABLE_TRACK=0,eventid,EVENT_GAME_TRACKABLE_TRACK,"(008)ÓÎÏ·ÊÂ¼þ - Êó±êÒÆ¶¯µ½¿É×·×ÙÎï"
ID_EVENT_GAME_SHOW_SKILL=0,eventid,EVENT_GAME_SHOW_SKILL,"(009)ÓÎÏ·ÊÂ¼þ - Ó¢ÐÛ¼¼ÄÜ°´Å¥±»µã»÷"
ID_EVENT_GAME_SHOW_SKILL=0,eventid,EVENT_GAME_SHOW_SKILL,"(010)ÓÎÏ·ÊÂ¼þ - ½¨Ôì½¨Öþ°´Å¥±»µã»÷"

//===================================================
// For use with TriggerRegisterPlayerEvent
//===================================================
ID_EVENT_PLAYER_STATE_LIMIT=0,eventid,EVENT_PLAYER_STATE_LIMIT,"(011)Íæ¼ÒÊÂ¼þ - ÊôÐÔ±ä»¯"
ID_EVENT_PLAYER_ALLIANCE_CHANGED=0,eventid,EVENT_PLAYER_ALLIANCE_CHANGED,"(012)Íæ¼ÒÊÂ¼þ - ÁªÃË×´Ì¬±ä»¯"
ID_EVENT_PLAYER_DEFEAT=0,eventid,EVENT_PLAYER_DEFEAT,"(013)Íæ¼ÒÊÂ¼þ - ÓÎÏ·Ê§°Ü"
ID_EVENT_PLAYER_VICTORY=0,eventid,EVENT_PLAYER_VICTORY,"(014)Íæ¼ÒÊÂ¼þ - ÓÎÏ·Ê¤Àû"
ID_EVENT_PLAYER_LEAVE=0,eventid,EVENT_PLAYER_LEAVE,"(015)Íæ¼ÒÊÂ¼þ - Àë¿ªÓÎÏ·"
ID_EVENT_PLAYER_CHAT=0,eventid,EVENT_PLAYER_CHAT,"(016)Íæ¼ÒÊÂ¼þ - ÊäÈëÁÄÌìÏûÏ¢"
ID_EVENT_PLAYER_END_CINEMATIC=0,eventid,EVENT_PLAYER_END_CINEMATIC,"(017)Íæ¼ÒÊÂ¼þ - °´ÏÂEsc¼ü"

//===================================================
// For use with TriggerRegisterPlayerUnitEvent
//===================================================
ID_EVENT_PLAYER_UNIT_ATTACKED=0,eventid,EVENT_PLAYER_UNIT_ATTACKED,"(018)Íæ¼Òµ¥Î»ÊÂ¼þ - ±»¹¥»÷"
ID_EVENT_PLAYER_UNIT_RESCUED=0,eventid,EVENT_PLAYER_UNIT_RESCUED,"(019)Íæ¼Òµ¥Î»ÊÂ¼þ - ±»Óª¾È"
ID_EVENT_PLAYER_UNIT_DEATH=0,eventid,EVENT_PLAYER_UNIT_DEATH,"(020)Íæ¼Òµ¥Î»ÊÂ¼þ - ËÀÍö"
ID_EVENT_PLAYER_UNIT_DECAY=0,eventid,EVENT_PLAYER_UNIT_DECAY,"(021)Íæ¼Òµ¥Î»ÊÂ¼þ - ¿ªÊ¼¸¯»¯"
ID_EVENT_PLAYER_UNIT_DETECTED=0,eventid,EVENT_PLAYER_UNIT_DETECTED,"(022)Íæ¼Òµ¥Î»ÊÂ¼þ - ±»Õì²âµ½"
ID_EVENT_PLAYER_UNIT_HIDDEN=0,eventid,EVENT_PLAYER_UNIT_HIDDEN,"(023)Íæ¼Òµ¥Î»ÊÂ¼þ - ±»Òþ²Ø"
ID_EVENT_PLAYER_UNIT_SELECTED=0,eventid,EVENT_PLAYER_UNIT_SELECTED,"(024)Íæ¼Òµ¥Î»ÊÂ¼þ - ±»Ñ¡Ôñ"
ID_EVENT_PLAYER_UNIT_DESELECTED=0,eventid,EVENT_PLAYER_UNIT_DESELECTED,"(025)Íæ¼Òµ¥Î»ÊÂ¼þ - ±»È¡ÏûÑ¡Ôñ"
ID_EVENT_PLAYER_UNIT_CONSTRUCT_START=0,eventid,EVENT_PLAYER_UNIT_CONSTRUCT_START,"(026)Íæ¼Òµ¥Î»ÊÂ¼þ - ¿ªÊ¼±»½¨Ôì"
ID_EVENT_PLAYER_UNIT_CONSTRUCT_CANCEL=0,eventid,EVENT_PLAYER_UNIT_CONSTRUCT_CANCEL,"(027)Íæ¼Òµ¥Î»ÊÂ¼þ - ±»È¡Ïû½¨Ôì"
ID_EVENT_PLAYER_UNIT_CONSTRUCT_FINISH=0,eventid,EVENT_PLAYER_UNIT_CONSTRUCT_FINISH,"(028)Íæ¼Òµ¥Î»ÊÂ¼þ - Íê³É½¨Ôì"
ID_EVENT_PLAYER_UNIT_UPGRADE_START=0,eventid,EVENT_PLAYER_UNIT_UPGRADE_START,"(029)Íæ¼Òµ¥Î»ÊÂ¼þ - ¿ªÊ¼½¨ÖþÉý¼¶"
ID_EVENT_PLAYER_UNIT_UPGRADE_CANCEL=0,eventid,EVENT_PLAYER_UNIT_UPGRADE_CANCEL,"(030)Íæ¼Òµ¥Î»ÊÂ¼þ - È¡Ïû½¨ÖþÉý¼¶"
ID_EVENT_PLAYER_UNIT_UPGRADE_FINISH=0,eventid,EVENT_PLAYER_UNIT_UPGRADE_FINISH,"(031)Íæ¼Òµ¥Î»ÊÂ¼þ - Íê³É½¨ÖþÉý¼¶"
ID_EVENT_PLAYER_UNIT_TRAIN_START=0,eventid,EVENT_PLAYER_UNIT_TRAIN_START,"(032)Íæ¼Òµ¥Î»ÊÂ¼þ - ¿ªÊ¼ÑµÁ·µ¥Î»"
ID_EVENT_PLAYER_UNIT_TRAIN_CANCEL=0,eventid,EVENT_PLAYER_UNIT_TRAIN_CANCEL,"(033)Íæ¼Òµ¥Î»ÊÂ¼þ - È¡ÏûÑµÁ·µ¥Î»"
ID_EVENT_PLAYER_UNIT_TRAIN_FINISH=0,eventid,EVENT_PLAYER_UNIT_TRAIN_FINISH,"(034)Íæ¼Òµ¥Î»ÊÂ¼þ - Íê³ÉÑµÁ·µ¥Î»"
ID_EVENT_PLAYER_UNIT_RESEARCH_START=0,eventid,EVENT_PLAYER_UNIT_RESEARCH_START,"(035)Íæ¼Òµ¥Î»ÊÂ¼þ - ¿ªÊ¼ÑÐ¾¿¿Æ¼¼"
ID_EVENT_PLAYER_UNIT_RESEARCH_CANCEL=0,eventid,EVENT_PLAYER_UNIT_RESEARCH_CANCEL,"(036)Íæ¼Òµ¥Î»ÊÂ¼þ - È¡ÏûÑÐ¾¿¿Æ¼¼"
ID_EVENT_PLAYER_UNIT_RESEARCH_FINISH=0,eventid,EVENT_PLAYER_UNIT_RESEARCH_FINISH,"(037)Íæ¼Òµ¥Î»ÊÂ¼þ - Íê³ÉÑÐ¾¿¿Æ¼¼"
ID_EVENT_PLAYER_UNIT_ISSUED_ORDER=0,eventid,EVENT_PLAYER_UNIT_ISSUED_ORDER,"(038)Íæ¼Òµ¥Î»ÊÂ¼þ - ·¢²¼ÎÞÄ¿±êÖ¸Áî"
ID_EVENT_PLAYER_UNIT_ISSUED_POINT_ORDER=0,eventid,EVENT_PLAYER_UNIT_ISSUED_POINT_ORDER,"(039)Íæ¼Òµ¥Î»ÊÂ¼þ - ·¢²¼Ö¸¶¨µãÄ¿±êÖ¸Áî"
ID_EVENT_PLAYER_UNIT_ISSUED_TARGET_ORDER=0,eventid,EVENT_PLAYER_UNIT_ISSUED_TARGET_ORDER,"(040)Íæ¼Òµ¥Î»ÊÂ¼þ - ·¢²¼Ö¸¶¨ÎïÌåÄ¿±êÖ¸Áî"
ID_EVENT_PLAYER_HERO_LEVEL=0,eventid,EVENT_PLAYER_HERO_LEVEL,"(041)Íæ¼Òµ¥Î»ÊÂ¼þ - ÌáÉýµÈ¼¶"
ID_EVENT_PLAYER_HERO_SKILL=0,eventid,EVENT_PLAYER_HERO_SKILL,"(042)Íæ¼Òµ¥Î»ÊÂ¼þ - Ñ§Ï°¼¼ÄÜ"
ID_EVENT_PLAYER_HERO_REVIVABLE=0,eventid,EVENT_PLAYER_HERO_REVIVABLE,"(043)Íæ¼Òµ¥Î»ÊÂ¼þ - ±äµÃ¿ÉÖØÉú"
ID_EVENT_PLAYER_HERO_REVIVE_START=0,eventid,EVENT_PLAYER_HERO_REVIVE_START,"(044)Íæ¼Òµ¥Î»ÊÂ¼þ - ¿ªÊ¼¸´»îÓ¢ÐÛ"
ID_EVENT_PLAYER_HERO_REVIVE_CANCEL=0,eventid,EVENT_PLAYER_HERO_REVIVE_CANCEL,"(045)Íæ¼Òµ¥Î»ÊÂ¼þ - È¡Ïû¸´»îÓ¢ÐÛ"
ID_EVENT_PLAYER_HERO_REVIVE_FINISH=0,eventid,EVENT_PLAYER_HERO_REVIVE_FINISH,"(046)Íæ¼Òµ¥Î»ÊÂ¼þ - Íê³É¸´»îÓ¢ÐÛ"
ID_EVENT_PLAYER_UNIT_SUMMON=0,eventid,EVENT_PLAYER_UNIT_SUMMON,"(047)Íæ¼Òµ¥Î»ÊÂ¼þ - ±»ÕÙ»½"
ID_EVENT_PLAYER_UNIT_DROP_ITEM=0,eventid,EVENT_PLAYER_UNIT_DROP_ITEM,"(048)Íæ¼Òµ¥Î»ÊÂ¼þ - ¶ªÆúÎïÆ·"
ID_EVENT_PLAYER_UNIT_PICKUP_ITEM=0,eventid,EVENT_PLAYER_UNIT_PICKUP_ITEM,"(049)Íæ¼Òµ¥Î»ÊÂ¼þ - »ñµÃÎïÆ·"
ID_EVENT_PLAYER_UNIT_USE_ITEM=0,eventid,EVENT_PLAYER_UNIT_USE_ITEM,"(050)Íæ¼Òµ¥Î»ÊÂ¼þ - Ê¹ÓÃÎïÆ·"
ID_EVENT_PLAYER_UNIT_LOADED=0,eventid,EVENT_PLAYER_UNIT_LOADED,"(051)Íæ¼Òµ¥Î»ÊÂ¼þ - ±»ÔËÊä»ú×°ÔØ"

//===================================================
// For use with TriggerRegisterUnitEvent
//===================================================
ID_EVENT_UNIT_DAMAGED=0,eventid,EVENT_UNIT_DAMAGED,"(052)µ¥Î»ÊÂ¼þ - ½ÓÊÜÉËº¦"
ID_EVENT_UNIT_DEATH=0,eventid,EVENT_UNIT_DEATH,"(053)µ¥Î»ÊÂ¼þ - ËÀÍö"
ID_EVENT_UNIT_DECAY=0,eventid,EVENT_UNIT_DECAY,"(054)µ¥Î»ÊÂ¼þ - ¿ªÊ¼¸¯»¯"
ID_EVENT_UNIT_DETECTED=0,eventid,EVENT_UNIT_DETECTED,"(055)µ¥Î»ÊÂ¼þ - ±»Õì²âµ½"
ID_EVENT_UNIT_HIDDEN=0,eventid,EVENT_UNIT_HIDDEN,"(056)µ¥Î»ÊÂ¼þ - ±»Òþ²Ø"
ID_EVENT_UNIT_SELECTED=0,eventid,EVENT_UNIT_SELECTED,"(057)µ¥Î»ÊÂ¼þ - ±»Ñ¡Ôñ"
ID_EVENT_UNIT_DESELECTED=0,eventid,EVENT_UNIT_DESELECTED,"(058)µ¥Î»ÊÂ¼þ - ±»È¡ÏûÑ¡Ôñ"
ID_EVENT_UNIT_STATE_LIMIT=0,eventid,EVENT_UNIT_STATE_LIMIT,"(059)µ¥Î»ÊÂ¼þ - ÉúÃüÖµ/Ä§·¨Öµ·¢Éú±ä»¯"
ID_EVENT_UNIT_ACQUIRED_TARGET=0,eventid,EVENT_UNIT_ACQUIRED_TARGET,"(060)µ¥Î»ÊÂ¼þ - ×¢Òâµ½¹¥»÷Ä¿±ê"
ID_EVENT_UNIT_TARGET_IN_RANGE=0,eventid,EVENT_UNIT_TARGET_IN_RANGE,"(061)µ¥Î»ÊÂ¼þ - »ñÈ¡¹¥»÷Ä¿±ê"
ID_EVENT_UNIT_ATTACKED=0,eventid,EVENT_UNIT_ATTACKED,"(062)µ¥Î»ÊÂ¼þ - ±»¹¥»÷"
ID_EVENT_UNIT_RESCUED=0,eventid,EVENT_UNIT_RESCUED,"(063)µ¥Î»ÊÂ¼þ - ±»Óª¾È"
ID_EVENT_UNIT_CONSTRUCT_CANCEL=0,eventid,EVENT_UNIT_CONSTRUCT_CANCEL,"(064)µ¥Î»ÊÂ¼þ - ±»È¡Ïû½¨Ôì"
ID_EVENT_UNIT_CONSTRUCT_FINISH=0,eventid,EVENT_UNIT_CONSTRUCT_FINISH,"(065)µ¥Î»ÊÂ¼þ - Íê³É½¨Ôì"
ID_EVENT_UNIT_UPGRADE_START=0,eventid,EVENT_UNIT_UPGRADE_START,"(066)µ¥Î»ÊÂ¼þ - ¿ªÊ¼½¨ÖþÉý¼¶"
ID_EVENT_UNIT_UPGRADE_CANCEL=0,eventid,EVENT_UNIT_UPGRADE_CANCEL,"(067)µ¥Î»ÊÂ¼þ - È¡Ïû½¨ÖþÉý¼¶"
ID_EVENT_UNIT_UPGRADE_FINISH=0,eventid,EVENT_UNIT_UPGRADE_FINISH,"(068)µ¥Î»ÊÂ¼þ - Íê³É½¨ÖþÉý¼¶"
ID_EVENT_UNIT_TRAIN_START=0,eventid,EVENT_UNIT_TRAIN_START,"(069)µ¥Î»ÊÂ¼þ - ¿ªÊ¼ÑµÁ·µ¥Î»"
ID_EVENT_UNIT_TRAIN_CANCEL=0,eventid,EVENT_UNIT_TRAIN_CANCEL,"(070)µ¥Î»ÊÂ¼þ - È¡ÏûÑµÁ·µ¥Î»"
ID_EVENT_UNIT_TRAIN_FINISH=0,eventid,EVENT_UNIT_TRAIN_FINISH,"(071)µ¥Î»ÊÂ¼þ - Íê³ÉÑµÁ·µ¥Î»"
ID_EVENT_UNIT_RESEARCH_START=0,eventid,EVENT_UNIT_RESEARCH_START,"(072)µ¥Î»ÊÂ¼þ - ¿ªÊ¼ÑÐ¾¿¿Æ¼¼"
ID_EVENT_UNIT_RESEARCH_CANCEL=0,eventid,EVENT_UNIT_RESEARCH_CANCEL,"(073)µ¥Î»ÊÂ¼þ - È¡ÏûÑÐ¾¿¿Æ¼¼"
ID_EVENT_UNIT_RESEARCH_FINISH=0,eventid,EVENT_UNIT_RESEARCH_FINISH,"(074)µ¥Î»ÊÂ¼þ - Íê³ÉÑÐ¾¿¿Æ¼¼"
ID_EVENT_UNIT_ISSUED_ORDER=0,eventid,EVENT_UNIT_ISSUED_ORDER,"(075)µ¥Î»ÊÂ¼þ - ·¢²¼ÎÞÄ¿±êÖ¸Áî"
ID_EVENT_UNIT_ISSUED_POINT_ORDER=0,eventid,EVENT_UNIT_ISSUED_POINT_ORDER,"(076)µ¥Î»ÊÂ¼þ - ·¢²¼Ö¸¶¨µãÄ¿±êÖ¸Áî"
ID_EVENT_UNIT_ISSUED_TARGET_ORDER=0,eventid,EVENT_UNIT_ISSUED_TARGET_ORDER,"(077)µ¥Î»ÊÂ¼þ - ·¢²¼Ö¸¶¨ÎïÌåÄ¿±êÖ¸Áî"
ID_EVENT_UNIT_HERO_LEVEL=0,eventid,EVENT_UNIT_HERO_LEVEL,"(078)µ¥Î»ÊÂ¼þ - ÌáÉýµÈ¼¶"
ID_EVENT_UNIT_HERO_SKILL=0,eventid,EVENT_UNIT_HERO_SKILL,"(079)µ¥Î»ÊÂ¼þ - Ñ§Ï°¼¼ÄÜ"
ID_EVENT_UNIT_HERO_REVIVABLE=0,eventid,EVENT_UNIT_HERO_REVIVABLE,"(080)µ¥Î»ÊÂ¼þ - ±äµÃ¿ÉÖØÉú"
ID_EVENT_UNIT_HERO_REVIVE_START=0,eventid,EVENT_UNIT_HERO_REVIVE_START,"(081)µ¥Î»ÊÂ¼þ - ¿ªÊ¼¸´»îÓ¢ÐÛ"
ID_EVENT_UNIT_HERO_REVIVE_CANCEL=0,eventid,EVENT_UNIT_HERO_REVIVE_CANCEL,"(082)µ¥Î»ÊÂ¼þ - È¡Ïû¸´»îÓ¢ÐÛ"
ID_EVENT_UNIT_HERO_REVIVE_FINISH=0,eventid,EVENT_UNIT_HERO_REVIVE_FINISH,"(083)µ¥Î»ÊÂ¼þ - Íê³É¸´»îÓ¢ÐÛ"
ID_EVENT_UNIT_SUMMON=0,eventid,EVENT_UNIT_SUMMON,"(084)µ¥Î»ÊÂ¼þ - ÕÙ»½Ò»¸öµ¥Î»"
ID_EVENT_UNIT_DROP_ITEM=0,eventid,EVENT_UNIT_DROP_ITEM,"(085)µ¥Î»ÊÂ¼þ - ¶ªÆúÎïÆ·"
ID_EVENT_UNIT_PICKUP_ITEM=0,eventid,EVENT_UNIT_PICKUP_ITEM,"(086)µ¥Î»ÊÂ¼þ - »ñµÃÎïÆ·"
ID_EVENT_UNIT_USE_ITEM=0,eventid,EVENT_UNIT_USE_ITEM,"(087)µ¥Î»ÊÂ¼þ - Ê¹ÓÃÎïÆ·"
ID_EVENT_UNIT_LOADED=0,eventid,EVENT_UNIT_LOADED,"(088)µ¥Î»ÊÂ¼þ - ±»ÔËÊä»ú×°ÔØ"
	
//===================================================
// Other
//===================================================
ID_EVENT_WIDGET_DEATH=0,eventid,EVENT_WIDGET_DEATH,"(089)widgetÊÂ¼þ - ËÀÍö"
ID_EVENT_DIALOG_BUTTON_CLICK=0,eventid,EVENT_DIALOG_BUTTON_CLICK,"(090)¶Ô»°¿òÊÂ¼þ - ¶Ô»°¿ò°´Å¥±»µã»÷"
ID_EVENT_DIALOG_CLICK=0,eventid,EVENT_DIALOG_CLICK,"(091)¶Ô»°¿òÊÂ¼þ - ¶Ô»°¿ò±»µã»÷"
...
// For use with TriggerRegisterGameEvent    
//===================================================
ID_EVENT_GAME_LOADED=0,eventid,EVENT_GAME_LOADED,"(256)ÓÎÏ·ÊÂ¼þ - ÓÎÏ·¶Áµµ"
ID_EVENT_GAME_TOURNAMENT_FINISH_SOON=0,eventid,EVENT_GAME_TOURNAMENT_FINISH_SOON,"(257)ÓÎÏ·ÊÂ¼þ - ÓÎÏ·½«ÔÚÏÖÔÚ½áÊø"
ID_EVENT_GAME_TOURNAMENT_FINISH_NOW=0,eventid,EVENT_GAME_TOURNAMENT_FINISH_NOW,"(258)ÓÎÏ·ÊÂ¼þ - ÓÎÏ·½«ÔÚ²»¾Ã½áÊø"
ID_EVENT_GAME_SAVE=0,eventid,EVENT_GAME_SAVE,"(259)ÓÎÏ·ÊÂ¼þ - ÓÎÏ·´æµµ"

//===================================================
// For use with TriggerRegisterPlayerEvent
//===================================================
ID_EVENT_PLAYER_ARROW_LEFT_DOWN=0,eventid,EVENT_PLAYER_ARROW_LEFT_DOWN,"(261)Íæ¼Ò¼üÅÌÊÂ¼þ - °´ÏÂLeft¼ü"
ID_EVENT_PLAYER_ARROW_LEFT_UP=0,eventid,EVENT_PLAYER_ARROW_LEFT_UP,"(262)Íæ¼Ò¼üÅÌÊÂ¼þ - °´ÉÏLeft¼ü"
ID_EVENT_PLAYER_ARROW_RIGHT_DOWN=0,eventid,EVENT_PLAYER_ARROW_RIGHT_DOWN,"(263)Íæ¼Ò¼üÅÌÊÂ¼þ - °´ÏÂRight¼ü"
ID_EVENT_PLAYER_ARROW_RIGHT_UP=0,eventid,EVENT_PLAYER_ARROW_RIGHT_UP,"(264)Íæ¼Ò¼üÅÌÊÂ¼þ - °´ÉÏRight¼ü"
ID_EVENT_PLAYER_ARROW_DOWN_DOWN=0,eventid,EVENT_PLAYER_ARROW_DOWN_DOWN,"(265)Íæ¼Ò¼üÅÌÊÂ¼þ - °´ÏÂDown¼ü"
ID_EVENT_PLAYER_ARROW_DOWN_UP=0,eventid,EVENT_PLAYER_ARROW_DOWN_UP,"(266)Íæ¼Ò¼üÅÌÊÂ¼þ - °´ÉÏDown¼ü"
ID_EVENT_PLAYER_ARROW_UP_DOWN=0,eventid,EVENT_PLAYER_ARROW_UP_DOWN,"(267)Íæ¼Ò¼üÅÌÊÂ¼þ - °´ÏÂUp¼ü"
ID_EVENT_PLAYER_ARROW_UP_UP=0,eventid,EVENT_PLAYER_ARROW_UP_UP,"(268)Íæ¼Ò¼üÅÌÊÂ¼þ - °´ÉÏUp¼ü"

//===================================================
// For use with TriggerRegisterPlayerUnitEvent
//===================================================
ID_EVENT_PLAYER_UNIT_SELL=0,eventid,EVENT_PLAYER_UNIT_SELL,"(269)Íæ¼Òµ¥Î»ÊÂ¼þ - ³öÊÛµ¥Î»"
ID_EVENT_PLAYER_UNIT_CHANGE_OWNER=0,eventid,EVENT_PLAYER_UNIT_CHANGE_OWNER,"(270)Íæ¼Òµ¥Î»ÊÂ¼þ - ¸Ä±äËùÓÐÕß"
ID_EVENT_PLAYER_UNIT_SELL_ITEM=0,eventid,EVENT_PLAYER_UNIT_SELL_ITEM,"(271)Íæ¼Òµ¥Î»ÊÂ¼þ - ³öÊÛÎïÆ·"
ID_EVENT_PLAYER_UNIT_SPELL_CHANNEL=0,eventid,EVENT_PLAYER_UNIT_SPELL_CHANNEL,"(272)Íæ¼Òµ¥Î»ÊÂ¼þ - ×¼±¸Ê©·Å¼¼ÄÜ"
ID_EVENT_PLAYER_UNIT_SPELL_CAST=0,eventid,EVENT_PLAYER_UNIT_SPELL_CAST,"(273)Íæ¼Òµ¥Î»ÊÂ¼þ - ¿ªÊ¼Ê©·Å¼¼ÄÜ"
ID_EVENT_PLAYER_UNIT_SPELL_EFFECT=0,eventid,EVENT_PLAYER_UNIT_SPELL_EFFECT,"(273)Íæ¼Òµ¥Î»ÊÂ¼þ - ·¢¶¯¼¼ÄÜÐ§¹û"
ID_EVENT_PLAYER_UNIT_SPELL_FINISH=0,eventid,EVENT_PLAYER_UNIT_SPELL_FINISH,"(275)Íæ¼Òµ¥Î»ÊÂ¼þ - Ê©·Å¼¼ÄÜ½áÊø"
ID_EVENT_PLAYER_UNIT_SPELL_ENDCAST=0,eventid,EVENT_PLAYER_UNIT_SPELL_ENDCAST,"(276)Íæ¼Òµ¥Î»ÊÂ¼þ - Í£Ö¹Ê©·Å¼¼ÄÜ"
ID_EVENT_PLAYER_UNIT_PAWN_ITEM=0,eventid,EVENT_PLAYER_UNIT_PAWN_ITEM,"(277)Íæ¼Òµ¥Î»ÊÂ¼þ - µÖÑºÎïÆ·"

//===================================================
// For use with TriggerRegisterUnitEvent
//===================================================
ID_EVENT_UNIT_SELL=0,eventid,EVENT_UNIT_SELL,"(286)µ¥Î»ÊÂ¼þ - ³öÊÛµ¥Î»"
ID_EVENT_UNIT_CHANGE_OWNER=0,eventid,EVENT_UNIT_CHANGE_OWNER,"(287)µ¥Î»ÊÂ¼þ - ¸Ä±äËùÓÐÕß"
ID_EVENT_UNIT_SELL_ITEM=0,eventid,EVENT_PLAYER_SELL_ITEM,"(288)µ¥Î»ÊÂ¼þ - ³öÊÛÎïÆ·"
ID_EVENT_UNIT_SPELL_CHANNEL=0,eventid,EVENT_UNIT_SPELL_CHANNEL,"(289)µ¥Î»ÊÂ¼þ - ×¼±¸Ê©·Å¼¼ÄÜ"
ID_EVENT_UNIT_SPELL_CAST=0,eventid,EVENT_UNIT_SPELL_CAST,"(290)µ¥Î»ÊÂ¼þ - ¿ªÊ¼Ê©·Å¼¼ÄÜ"
ID_EVENT_UNIT_SPELL_EFFECT=0,eventid,EVENT_UNIT_SPELL_EFFECT,"(291)µ¥Î»ÊÂ¼þ - ·¢¶¯¼¼ÄÜÐ§¹û"
ID_EVENT_UNIT_SPELL_FINISH=0,eventid,EVENT_UNIT_SPELL_FINISH,"(292)µ¥Î»ÊÂ¼þ - Ê©·Å¼¼ÄÜ½áÊø"
ID_EVENT_UNIT_SPELL_ENDCAST=0,eventid,EVENT_UNIT_SPELL_ENDCAST,"(293)µ¥Î»ÊÂ¼þ - Í£Ö¹Ê©·Å¼¼ÄÜ"
ID_EVENT_UNIT_PAWN_ITEM=0,eventid,EVENT_UNIT_PAWN_ITEM,"(294)µ¥Î»ÊÂ¼þ - µÖÑºÎïÆ·"


ABILITY_STATE_COOLDOWN=0,AbilityState,1,ÀäÈ´Ê±¼ä

//ABILITY_DATA_TARGS=0,AbilityDataInteger,100,ç›®æ ‡å…è®¸
ABILITY_DATA_COST=0,AbilityDataInteger,104,Ä§·¨ÏûºÄ
ABILITY_DATA_UNITID=0,AbilityDataInteger,117,µ¥Î»ÀàÐÍ
ABILITY_DATA_HOTKET=0,AbilityDataInteger,200,ÈÈ¼ü
ABILITY_DATA_UNHOTKET=0,AbilityDataInteger,201,¹Ø±ÕÈÈ¼ü
ABILITY_DATA_RESEARCH_HOTKEY=0,AbilityDataInteger,202,Ñ§Ï°ÈÈ¼ü

ABILITY_DATA_CAST=0,AbilityDataReal,101,Ê©·ÅÊ±¼ä
ABILITY_DATA_DUR=0,AbilityDataReal,102,³ÖÐøÊ±¼ä(ÆÕÍ¨)
ABILITY_DATA_HERODUR=0,AbilityDataReal,113,³ÖÐøÊ±¼ä(Ó¢ÐÛ)
ABILITY_DATA_COOL=0,AbilityDataReal,105,Ê©·Å¼ä¸ô
ABILITY_DATA_AREA=0,AbilityDataReal,106,Ó°ÏìÇøÓò
ABILITY_DATA_RNG=0,AbilityDataReal,107,Ê©·¨¾àÀë
ABILITY_DATA_DATA_A=0,AbilityDataReal,108,Êý¾ÝA
ABILITY_DATA_DATA_B=0,AbilityDataReal,109,Êý¾ÝB
ABILITY_DATA_DATA_C=0,AbilityDataReal,110,Êý¾ÝC
ABILITY_DATA_DATA_D=0,AbilityDataReal,111,Êý¾ÝD
ABILITY_DATA_DATA_E=0,AbilityDataReal,112,Êý¾ÝE
ABILITY_DATA_DATA_F=0,AbilityDataReal,113,Êý¾ÝF
ABILITY_DATA_DATA_G=0,AbilityDataReal,114,Êý¾ÝG
ABILITY_DATA_DATA_H=0,AbilityDataReal,115,Êý¾ÝH
ABILITY_DATA_DATA_I=0,AbilityDataReal,116,Êý¾ÝI

ABILITY_DATA_NAME=0,AbilityDataString,203,Ãû×Ö
ABILITY_DATA_ART=0,AbilityDataString,204,Í¼±ê
ABILITY_DATA_TARGET_ART=0,AbilityDataString,205,Ä¿±êÐ§¹û
ABILITY_DATA_CASTER_ART=0,AbilityDataString,206,Ê©·¨ÕßÐ§¹û
ABILITY_DATA_EFFECT_ART=0,AbilityDataString,207,Ä¿±êµãÐ§¹û
ABILITY_DATA_AREAEFFECT_ART=0,AbilityDataString,208,ÇøÓòÐ§¹û
ABILITY_DATA_MISSILE_ART=0,AbilityDataString,209,Í¶ÉäÎï
ABILITY_DATA_SPECIAL_ART=0,AbilityDataString,210,ÌØÊâÐ§¹û
ABILITY_DATA_LIGHTNING_EFFECT=0,AbilityDataString,211,ÉÁµçÐ§¹û
ABILITY_DATA_BUFF_TIP=0,AbilityDataString,212,buffÌáÊ¾
ABILITY_DATA_BUFF_UBERTIP=0,AbilityDataString,213,buffÌáÊ¾(À©Õ¹)
ABILITY_DATA_RESEARCH_TIP=0,AbilityDataString,214,Ñ§Ï°ÌáÊ¾
ABILITY_DATA_TIP=0,AbilityDataString,215,ÌáÊ¾
ABILITY_DATA_UNTIP=0,AbilityDataString,216,¹Ø±ÕÌáÊ¾
ABILITY_DATA_RESEARCH_UBERTIP=0,AbilityDataString,217,Ñ§Ï°ÌáÊ¾(À©Õ¹)
ABILITY_DATA_UBERTIP=0,AbilityDataString,218,ÌáÊ¾(À©Õ¹)
ABILITY_DATA_UNUBERTIP=0,AbilityDataString,219,¹Ø±ÕÌáÊ¾(À©Õ¹)

CHAT_RECIPIENT_ALL=0,ChatRecipient,0,ËùÓÐÈËÆµµÀ
CHAT_RECIPIENT_ALLIES=0,ChatRecipient,1,ÃËÓÑÆµµÀ
CHAT_RECIPIENT_OBSERVERS=0,ChatRecipient,2,¹Û¿´Õß/²ÃÅÐÆµµÀ
CHAT_RECIPIENT_PRIVATE=0,ChatRecipient,3,Ë½ÈËÆµµÀ
...
Trigger01Actions=5
Trigger01Action01=CommentString,"YDWEÊÇ¡¶Ä§ÊÞÕù°ÔIII¡·µØÍ¼±à¼­Æ÷µÄÒ»¸öÔöÇ¿Mod¡£"
Trigger01Action02=CommentString,"¡¡¡¡Äã¿ÉÒÔ´Ówww.ydwe.net»ñÈ¡×îÐÂµÄYDWE¡£"
Trigger01Action03=CommentString,"¡¡¡¡Äã¿ÉÒÔÓÉYDWE¸½´øµÄÑÝÊ¾µØÍ¼¿ªÊ¼£¬¿ìËÙÁË½âYDWEµÄ¹¦ÄÜ¡£"
Trigger01Action04=CommentString,"¡¡¡¡µ±ÄãµÄµØÍ¼ÒâÍâËð»µÊ±£¬Äã¿ÉÒÔÔÚbackupsÄ¿Â¼ÕÒµ½Äã×î½ü26´Î±£´æµÄµØÍ¼¡£"
Trigger01Action05=CommentString,"¡¡¡¡µ±ÄãµÄYDWE²»ÄÜÕý³£¹¤×÷Ê±£¬Äã¿ÉÒÔÇ°Íùwww.ydwe.netÁªÏµÎÒÃÇ¡£"
